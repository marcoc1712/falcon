...
$cmd->{'front:CARD=I82801AAICH,DEV=0'} = 'cat /proc/asound/I82801AAICH/codec97#0';
$cmd->{'hw:CARD=I82801AAICH,DEV=0'} = 'cat /proc/asound/I82801AAICH/codec97#0';
...
if (!$command) {
	push @lines, "Unable to find test command for: $audiodevice";
